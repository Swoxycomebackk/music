            ...
            [
                [
                    InlineKeyboardButton(
                        "🎉 𝖡𝖾𝗇𝗂 𝖦𝗋𝗎𝖻𝖺 𝖤𝗄𝗅𝖾 🎉", url=f"https://t.me/Swoxymusicc_robot?startgroup=true"
                    )
                ],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "🇹🇷 Swoxy", url="https://t.me/Swoxyx"
                    )
                ],
                [
                    InlineKeyboardButton(
                        "🧑🏻‍💻 Owner 🧑🏻‍💻", url="https://t.me/Swoxyalemdar"
                    )
                ]
...
async def herkes(_, query: CallbackQuery):
    ...
    reply_markup=InlineKeyboardMarkup(
             [
                 [
                     InlineKeyboardButton(
                         "🇹🇷 𝖠𝗌𝗂𝗌𝗍𝖺𝗇", url="https://t.me/SwoxyMusicAsistan"
                     ),
                     InlineKeyboardButton(
                         "🧑🏻‍💻 𝖮𝗐𝗇𝖾𝗋", url="https://t.me/Swoxyalemdar"
                     )
                 ],
                 [
                     InlineKeyboardButton(
